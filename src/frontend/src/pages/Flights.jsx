...
const Flights = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
      <motion.h1
        className="text-4xl font-extrabold text-center mb-12 text-rose-700"
        ...
        <div className="grid gap-8 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
          {flights.map((flight) => (
            ...
            >
              ...
              />
              <div className="p-6">
                <h2 className="text-2xl font-semibold text-rose-600 mb-2">{flight.airline}</h2>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    className="bg-rose-600 text-white px-4 py-2 rounded-md hover:bg-rose-700 transition-colors duration-300"
                  >
                    Book Now
                  </button>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-rose-600 mb-2">Features:</h3>
