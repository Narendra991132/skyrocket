        ...
        <div className="min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1519125323398-675f0ddb6308?&auto=format&fit=crop&w=1950&q=80)' }}>
            <div className="max-w-lg w-full bg-white bg-opacity-90 p-8 rounded-3xl shadow-2xl">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.firstname ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
                                    }`}
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.lastname ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
                                    }`}
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.username ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
                                    }`}
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="email"
                                required
                                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
                                    }`}
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="password"
                                required
                                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${errors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
                                    }`}
                    ...
                    <button
                        type="submit"
                        className="w-full py-3 bg-gradient-to-r from-purple-500 to-rose-600 text-white rounded-lg hover:from-purple-600 hover:to-rose-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-purple-300"
                    >
                        Register Now
                    </button>
